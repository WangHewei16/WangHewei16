...
Hi! I am Stephen👋, a master's student at Carnegie Mellon University (CMU), School of Computer Science. My interests lie in distributed systems, computer vision, and machine learning. I originally graduated from University College Dublin (UCD) in Ireland, earning a Bachelor’s in Software Engineering. During my time there, I took on a role as a research intern in the THEIA lab and collaborated with Nanyang Technological University (NTU), supervised by A.P. Yee Hui Lee and Dr. Soumyabrata Dev. My endeavors in the lab have culminated in about 10+ works published and delivered to esteemed conferences and journals including CVPR, IEEE, Elsevier, and ACM. Currently seeking 2024 **MLE/CVE** internships in the **United States**. Please feel free to contact me if there are any available opportunities, or if you are interested in my previous work.
...
💼 Worked as machine learning engineer intern at [CASIA](http://english.ia.cas.cn/) advised by [Dr. Xiwei Liu](http://www.ia.cas.cn/sourcedb_ia_cas/cn/iaexpert/202005/t20200529_5599970.html). <br />
